...
class TestEngine:
    ...
    def _inject_common_params(self, case: TestCase, case_key: str = None):
        ...
        # ⑤ 产品信息参数（输入范围 / 功率分段）
        # ============================================================
        case.params.setdefault("input_voltage_min", float(product_info.get("input_voltage_lo", 90.0)))
        case.params.setdefault("input_voltage_max", float(product_info.get("input_voltage_hi", 264.0)))
